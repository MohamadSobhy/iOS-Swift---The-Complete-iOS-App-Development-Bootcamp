...
class ViewController: UIViewController {
    ...
    @IBAction func onAnswerButtonClicked(_ sender: UIButton) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 0.2, target: self, selector: #selector(updateQuestionUI), userInfo: nil, repeats: false)
    }
    
    @objc private func updateQuestionUI() {
